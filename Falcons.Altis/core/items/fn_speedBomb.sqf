...
if(player distance _unit > 7) exitWith {titleText["Vous êtes pas dans le Rayon!","PLAIN"];};
...
{ [[2,"Une bombe de vitesse a été activé sur ce véhicule et si vous descender en dessous de 50km\H la bombe explose!"],"life_fnc_broadcast",_x,false] spawn BIS_fnc_MP; } foreach (crew _veh);
