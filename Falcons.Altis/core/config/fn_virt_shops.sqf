...
switch (_shop) do
{
	...
	case "iron": {["Altis Industrial Trader",["iron_r","copper_r","silver_r","pickaxe"]]};
	case "diamond": {["Diamond Dealer",["diamond","diamondc"]]};
	case "salt": {["Salt Dealer",["salt_r"]]};
	case "cop": {["Cop Item Shop",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","mauer","defusekit"]]};
	case "cement": {["Cement Dealer",["cement"]]};
	case "gold": {["Gold Buyer",["goldbar"]]};
	case "emeraude": {["Acheteur d'Emeraude",["emeraude_r"]]};
};