...
switch (_var) do
{
	...
	case "life_inv_emeraude": {(localize "STR_Item_Emeraude")}; //ADD THIS / AJOUTE CA
	case "life_inv_emerauder": {(localize "STR_Item_EmeraudePepite")}; //ADD THIS / AJOUTE CA
	...
	case "license_civ_emeraude": {(localize "STR_License_Emeraude")}; //ADD THIS / AJOUTE CA
	...
	case "license_civ_donat": {(localize "STR_License_donat")};
};
