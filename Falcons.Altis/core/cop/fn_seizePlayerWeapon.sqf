...
//titleText format["Prendre l'arme de %1", name cursorTarget];
[[52, player, format["Prendre l'arme de %1", name cursorTarget]],"TON_fnc_logIt",false,false] spawn life_fnc_MP;